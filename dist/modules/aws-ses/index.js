...
var AWS_SES = /** @class */ (function () {
    ...
    AWS_SES.prototype.createParams = function (input) {
        return new client_ses_1.CloneReceiptRuleSetCommand(input);
    };
    AWS_SES.prototype.sendMail = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var paramsToSend;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        paramsToSend = this.createParams(params);
                        return [4 /*yield*/, this.ses.send(paramsToSend)["catch"](function (err) {
